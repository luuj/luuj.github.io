...
The SEIR (susceptible, exposed, infectious, recovered) model is widely used to simulate infectious disease spread. <a href="https://www.nature.com/articles/s41586-020-2554-8">Hao et al.</a> recently proposed expanding this model by adding three new transition states: presymptomatic infectious, unascertained infectious, and hospital isolation.

While their model effectively predicted COVID-19 spread in Wuhan, we aimed to enhance its implementation. We incorporated a newer algorithm, DRAM (Delayed Rejection Adaptive Metropolis), into the Metropolis-Hastings step. This improvement significantly increased simulation speed from 1103 to 593 seconds without compromising statistical performance. See our implementation, proposal, and presentation <a href="https://github.com/luuj/Bayesian-Methodology/tree/main/SAPHIRE-master">here</a>.
...
Eribulin is a promising new treatment for bladder cancer. This combined phase I/II clinical trial aimed to assess whether Eribulin could advance to a phase III trial. At USC’s Norris Cancer Center, I collaborated with Susan Groshen on the statistical analysis of the trial data.

Our work involved several key tasks: first, we analyzed the frequency of adverse events to create toxicity tables for the DSMC report. Next, I developed scripts to generate Table I statistics, response tables, and Kaplan-Meier curves for progression-free and overall survival. Finally, I conducted a multivariate Cox regression analysis for progression-free survival. Check out the <a href="https://pubmed.ncbi.nlm.nih.gov/22198425/">paper</a> and <a href="https://github.com/luuj/Urothelial-carcinoma-study">my code here</a>.
